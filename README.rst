...
.. code-block:: bash
    ...
    cd MyTemplateWebsite
    celery -A MyTemplateWebsite.taskapp worker -l info
...
To run the tests, enter the MyTemplateWebsite/tests directory and run the following commands::
